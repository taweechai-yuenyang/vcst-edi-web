...
from .models import Corporation, Department, Employee, Factory, Position,Section, Supplier
from .serializers import CorporationSerializer, DepartmentSerializer, EmployeeSerializer, FactorySerializer, PositionSerializer, SectionSerializer, SupplierSerializer
