...
SECRET_KEY = 'django-insecure-(i+9hrl1jj7u964re-)sq6c8sg#0-9pl0e&2bfh^^n4u%w#m2w'
...
APPEND_SLASH = False
AUTH_USER_MODEL = 'users.ManagementUser'
...
JAZZMIN_SETTINGS = {
    ...
    "hide_models": ["forecasts.FileForecast","forecasts.ForecastDetail","forecasts.ForecastErrorLogs",],

    # List of apps (and/or models) to base side menu ordering off of (does not need to contain all apps/models)
    "order_with_respect_to": ["auth", "forecasts.Forecast", "supplier.Supplier", "supplier.RefType",],
    
    # "order_with_respect_to": ["open_pds.PDSHeader", "Make Messages"],
