    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('request_status', models.CharField(choices=[('0', 'In Progress'), ('1', 'Approve'), ('3', 'Reject')], default='0', max_length=1, verbose_name='Request Status')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ro_status', models.CharField(choices=[('0', 'In Progress'), ('1', 'Approve'), ('3', 'Reject')], default='0', max_length=1, verbose_name='Request Status')),
