    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'permissions': [('upload', 'อัพโหลดข้อมูล')],
            },
        ),
        migrations.CreateModel(
            name='Forecast',
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, verbose_name='PRIMARY KEY')),
                ('forecast_no', models.CharField(blank=True, max_length=50, null=True, verbose_name='Request No.')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pds_no', models.CharField(blank=True, max_length=50, null=True, verbose_name='PDS No.')),
                ('remark', models.TextField(blank=True, null=True, verbose_name='Remark')),
